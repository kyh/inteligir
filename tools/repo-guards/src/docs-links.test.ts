...
// treatment for `[]()`.
//
// It lives here rather than in @repo/notes or @repo/bridge because both of
// those are lint-banned from importing `node:*` (they are the platform-neutral
// seam) and this walk needs the filesystem. It reads the whole tree, so it
// belongs to no product package.
//
