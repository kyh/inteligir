...
function MultiFactorAuthSetupModal(
  ...
  const onEnrollSuccess = useCallback(() => {
    ...
    return toaster.success("Factor enrolled successfully");
  }, [props]);
    ...
    <div className="flex flex-col space-y-4">
      <p>
        <span className="text-base">
          Use your phone to scan the QR code below. Then enter the code
          generated.
        </span>
      </p>
    ...
    >
      <div className="flex flex-col space-y-4">
        <TextField.Label>
          ...
          <TextField.Hint>
            Use an easy-to-remember name to easily identify this factor in the
            future. Ex. iPhone 14
          </TextField.Hint>
        </TextField.Label>
