      ...
      <Dialog as="div" className="relative z-10" onClose={closeModal}>
        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="flex justify-center py-10 px-4 text-center">
            ...
            >
              <Dialog.Panel className="w-full max-w-xl transform overflow-hidden rounded-2xl bg-black-700 p-6 text-left shadow-xl transition-all text-slate-300 text-sm">
                {children}
              </Dialog.Panel>
            </Transition.Child>
          </div>
