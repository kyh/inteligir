      ...
      <DropdownMenu>
        ...
        <DropdownMenu.Content>
          <DropdownMenu.Item className="gap-x-2">
            <PenSquareIcon className="text-ui-fg-subtle" />
            Edit
          </DropdownMenu.Item>
          <DropdownMenu.Item className="gap-x-2">
            <PlusIcon className="text-ui-fg-subtle" />
            Add
          </DropdownMenu.Item>
          <DropdownMenu.Separator />
          <DropdownMenu.Item className="gap-x-2">
            <TrashIcon className="text-ui-fg-subtle" />
            Delete
          </DropdownMenu.Item>
        </DropdownMenu.Content>
      </DropdownMenu>
          ...
          <div>
            <DropdownMenu>
              ...
              <DropdownMenu.Content>
                ...
                <div className="flex items-center gap-x-2 border-t border-ui-border-base p-2">
