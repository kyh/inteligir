...
import {
  ...
  type IconName,
  type IconComponent,
} from "@repo/ui/lib/icon-map";

// Re-export types for consumers
export type { IconComponent, IconName, IconLibrary } from "@repo/ui/lib/icon-map";
export { iconLibraryOrder, iconLibraryLabels } from "@repo/ui/lib/icon-map";
