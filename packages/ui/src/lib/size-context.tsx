...
interface SizeClasses {
  ...
  control: string;
  // the body role: compact is the utility itself; the default step spells the scale's number as a
  // literal, because the utilities carry the compact column alone
  text: string;
  px: string;
  itemPx: string;
  gap: string;
