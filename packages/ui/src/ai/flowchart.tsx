...
const FlowchartConnector = ({
  ...
  ref,
  ...props
}: FlowchartConnectorProps & RefAttributes<HTMLDivElement>) => (
  <div
    ref={ref}
...
const FlowchartNode = ({
  ...
  ref,
  ...props
}: FlowchartNodeProps & RefAttributes<HTMLDivElement>) => (
  <div className="flex flex-col items-center" style={{ maxWidth: "100%", width }}>
    {kind === undefined ? null : (
      <span
    ...
    <div
      ...
      className={cn("w-full rounded-xl bg-surface-raised px-3 py-2.5 shadow-surface-2", className)}
      {...props}
    >
      {children}
    </div>
...
const FlowchartNodeTitle = ({
  className,
  children,
  icon,
  ref,
  ...props
}: FlowchartNodeTitleProps & RefAttributes<HTMLDivElement>) => (
  <div
    ref={ref}
...
const FlowchartCondition = ({
  ...
  ref,
  ...props
}: FlowchartConditionProps & RefAttributes<HTMLDivElement>) => (
  <div
    ref={ref}
