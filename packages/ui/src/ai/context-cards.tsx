...
const ContextCardListHeading = ({
  className,
  children,
  count,
  ref,
  ...props
}: ContextCardListHeadingProps & RefAttributes<HTMLDivElement>) => (
  <div
    ref={ref}
...
const ContextCard = ({
  ...
  ref,
  ...props
}: ContextCardProps & RefAttributes<HTMLDivElement>) => (
  <div
    ref={ref}
...
const ContextCardSource = ({
  ...
  ref,
  ...props
}: ContextCardSourceProps & RefAttributes<HTMLButtonElement>) => (
