...
const useTaskItem = (): TaskItemContextValue => {
...
const TaskList = ({
  ...
  ref,
  ...props
}: TaskListProps & RefAttributes<HTMLDivElement>) => {
...
const TaskItem = ({
  ...
  ref,
  ...props
}: TaskItemProps & RefAttributes<HTMLDivElement>) => {
  ...
  const context = useMemo(
    () => ({ expandable, open, setExpandable, toggle }),
...
const TaskItemRow = ({
  ...
  ref,
  ...props
}: TaskItemRowProps & RefAttributes<HTMLButtonElement>) => {
...
const TaskDetail = ({
  ...
  ref,
  ...props
}: TaskDetailProps & RefAttributes<HTMLDivElement>) => (
  <div
    ref={ref}
