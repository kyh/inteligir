...
function getPayloadConfigFromPayload(config: ChartConfig, payload: unknown, key: string) {
  ...
  const configLabelKey = stringProp(payload, key) ?? stringProp(payloadPayload, key) ?? key;

  return configLabelKey in config ? config[configLabelKey] : config[key];
}

// Dynamic-key string read off an unknown payload shape, without assertions.
function stringProp(source: object | undefined, key: string): string | undefined {
