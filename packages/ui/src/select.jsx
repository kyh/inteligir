...
var SelectSeparator = function (_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
...
var SelectScrollUpButton = function (_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
...
var SelectScrollDownButton = function (_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
