...
import { AddCustomConnectorDialog } from "@repo/app/settings/extensions/add-custom-connector-dialog";
import {
  CONNECTOR_CATALOG,
  CONNECTOR_GROUPS,
  type CatalogConnector,
} from "@repo/app/settings/extensions/connector-catalog";
import { ConnectorCard } from "@repo/app/settings/extensions/connector-card";
import {
  catalogInstallRequest,
  installConnector,
  uninstallConnector,
} from "@repo/app/settings/extensions/connector-install";
import { GoogleClientDialog } from "@repo/app/settings/extensions/google-client-dialog";
import {
  errorMessage,
  useBridgeResource,
  type SectionProps,
} from "@repo/app/settings/extensions/lib";
import { SecretPromptDialog } from "@repo/app/settings/extensions/secret-prompt-dialog";
import {
