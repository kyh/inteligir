 ...
 * time (createHost — alongside the other host seams), so it is in place
 * before any handler, boot task, or availability probe can land. */
 ...
 * answer is "not installed". Post-composition callers see identical
 * behavior. */
