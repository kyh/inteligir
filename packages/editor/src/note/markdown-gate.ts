...
import { analyzeMarkdown, gateReasonFor } from "@repo/editor/markdown/markdown-doc";
import type { GateReason } from "@repo/editor/markdown/markdown-doc";

export { describeGateReason } from "@repo/editor/markdown/markdown-doc";
export type { GateReason } from "@repo/editor/markdown/markdown-doc";
...
export const safeGateReason = (md: string): GateReason | null => {
  try {
