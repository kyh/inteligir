...
import { isEditorNotePrivate } from "@repo/editor/note-privacy";
import { createMarkdownStream, stripAiMarks } from "@repo/editor/ai/stream-markdown";
import { applyEditSuggestions } from "@repo/editor/ai/suggestions";
import {
  buildEditPrompt,
  CANNED_ACTIONS,
  editInstructionFor,
  generatePromptFor,
  type CannedActionId,
} from "@repo/editor/ai/ai-prompts";
import { runManager } from "@repo/editor/ai/run-manager";
import { MD_STRINGIFY, parseMarkdown } from "@repo/editor/markdown/markdown-doc";
import { hasConnectedProvider, useAiProviderStore } from "@repo/editor/stores/ai-provider-store";
