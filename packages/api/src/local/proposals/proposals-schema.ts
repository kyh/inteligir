// The suggested-edit payload vocabulary: what a review-mode turn captured, and
// the two verbs that resolve it.
//
...
export const getProposalResponseSchema = z.object({ proposal: proposalSchema }).strict();
...
export const resolveProposalResponseSchema = z
  .object({
