...
import { toggleEditorNotePrivate } from "@repo/editor/note-privacy";
import { useTheme } from "@repo/workspace/lib/use-theme";
import { useViewStore } from "@repo/workspace/stores/view-store";
import { useVoiceStore } from "@repo/workspace/stores/voice-store";
import { startReadAloud, stopReadAloud, useReadAloud } from "@repo/workspace/voice/read-aloud";
import { openNoteState, useOpenNote } from "@repo/editor/note/open-note-store";
import {
  useCreateFromTemplate,
  useOpenPeriodicNote,
} from "@repo/workspace/workspace/use-note-templates";
