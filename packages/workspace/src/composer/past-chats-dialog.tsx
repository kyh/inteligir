...
import { ChatMessageView, isRenderableMessage } from "@repo/workspace/composer/chat-message";
import { getBridge } from "@repo/bridge/client";
import { projectChatLog, type ChatMessage } from "@repo/workspace/stores/chat-log-view";
