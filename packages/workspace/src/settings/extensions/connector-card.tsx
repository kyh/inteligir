...
import type { CatalogConnector } from "@repo/workspace/settings/extensions/connector-catalog";
import { CONNECTOR_ICON_PATHS } from "@repo/workspace/settings/extensions/connector-icons";
