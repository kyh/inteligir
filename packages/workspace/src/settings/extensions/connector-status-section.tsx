...
import { ConnectorsSection } from "@repo/workspace/settings/extensions/connectors-section";
import type { SectionProps } from "@repo/workspace/settings/extensions/lib";
