...
import type { AssistantStreamEvent } from "@repo/workspace/stores/agent-store";
...
vi.mock("@repo/workspace/stores/voice-store", () => ({
  useVoiceStore: {
...
vi.mock("@repo/workspace/stores/agent-store", () => ({
...
const { installVoiceNarration } = await import("@repo/workspace/voice/narration");
