// ---------------------------------------------------------------------------
// Setup for the `workspace-dom` (jsdom) vitest project — wired in vitest.config.ts.
//
// jsdom implements no ResizeObserver, and workspace components legitimately use
