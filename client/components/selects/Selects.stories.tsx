...
import { Checkbox, CheckboxGroup, Radio, RadioGroup, Select } from '@components';
...
export const Checkboxes = () => (
  <div>
    <div>
      <State store={store}>
        <Checkbox onChange={e => store.set({ checked: e.target.checked })} value="checked" />
      </State>
    ...
    <div>
      <CheckboxGroup
        ...
        controls={[{ label: 'Brandon' }, { label: 'Johnson' }, { label: 'Jack' }]}
      />
    </div>
    <div>
      <CheckboxGroup
