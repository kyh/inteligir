        ...
        <svg width="220" height="220" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <linearGradient x1="50%" y1="0%" x2="50%" y2="100%" id="square-1-a">
              ...
              <stop stopColor="#4353FF" stopOpacity=".32" offset="100%" />
            </linearGradient>
            <linearGradient
              x1="18.74%"
              y1="17.384%"
            ...
            >
              ...
              <stop stopColor="#43F1FF" stopOpacity="0" offset="100%" />
            </linearGradient>
          </defs>
        ...
        <svg width="88" height="88" xmlns="http://www.w3.org/2000/svg">
          <defs>
            ...
            <linearGradient
              ...
              id="square-2-b"
            >
              <stop stopColor="#43F1FF" stopOpacity=".24" offset="0%" />
              <stop stopColor="#43F1FF" stopOpacity=".16" offset="100%" />
            </linearGradient>
          </defs>
          <g fill="none" fillRule="evenodd">
        ...
        <svg width="64" height="64" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <linearGradient x1="50%" y1="0%" x2="50%" y2="100%" id="square-3-a">
              <stop stopColor="#4353FF" offset="0%" />
              <stop stopColor="#4353FF" stopOpacity=".16" offset="100%" />
            </linearGradient>
            <linearGradient
              x1="-58.825%"
              y1="39.622%"
            ...
            >
              <stop stopColor="#43F1FF" stopOpacity=".24" offset="0%" />
              <stop stopColor="#43F1FF" stopOpacity=".163" offset="100%" />
            </linearGradient>
          </defs>
      ...
      <div className="hero-square hero-square-6 is-moving-object is-rotating">
        <svg width="128" height="128" xmlns="http://www.w3.org/2000/svg">
          <defs>
            ...
            >
              <stop stopColor="#43F1FF" offset="0%" />
              <stop stopColor="#43F1FF" stopOpacity=".24" offset="100%" />
            </linearGradient>
            <linearGradient
              x1="18.74%"
              y1="17.384%"
        ...
        <svg width="40" height="40" xmlns="http://www.w3.org/2000/svg">
          <defs>
            ...
            <linearGradient
              ...
              id="square-8-b"
            >
              <stop stopColor="#43F1FF" stopOpacity=".123" offset="0%" />
              <stop stopColor="#43F1FF" stopOpacity=".16" offset="100%" />
            </linearGradient>
          </defs>
          <g fill="none" fillRule="evenodd">
