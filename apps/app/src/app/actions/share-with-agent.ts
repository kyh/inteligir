// "Share with agent" (Moss's affordance): one clipboard payload handing an
...
- Notes use the Moss markdown dialect: [[wiki links]], {{formula}} pills, %%m:id%% comment anchors, and moss-* fenced blocks.
...
- The dialect's full spec ships with the inteligir app as agent skills (moss-notes first); read them before authoring dialect constructs if you can reach an install.
