...
// SecretStore's default cipher touches electron's safeStorage at call time;
// tests inject their own cipher, but the module import must still resolve.
vi.mock("electron", () => ({
  safeStorage: {
...
import { SecretStore, type SecretCipher } from "@/main/secrets";
