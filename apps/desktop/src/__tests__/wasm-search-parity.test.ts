...
// schema + SEARCH_SQL in @repo/notes/knowledge/sql-knowledge-store.ts — this
...
import { createSqliteKnowledgeStore } from "@repo/server/server/knowledge/sqlite-knowledge-store";
