...
// twin of the node:sqlite driver in @repo/features/server (sqlite-knowledge-
// store.ts). The schema, guards, and every query live in @repo/core
...
import type { SqlDriver } from "@repo/core/knowledge/sql-knowledge-store";
