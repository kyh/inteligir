        ...
        >
          <div className="flex flex-col space-y-4">
            ...
            <div className="flex justify-end space-x-2">
              <Modal.CancelButton onClick={onCancel} type="button" />
    ...
    >
      <div className="flex flex-col space-y-4">
        <TextField.Label>
          ...
          <TextField.Input autoComplete="off" name={inputName} required />
...
const QrImage = ({ src }: { src: string }) => {
  return <Image alt="QR Code" height={160} src={src} width={160} />;
};
