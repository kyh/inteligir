 ...
 * @name canUpdateUser
 */
export const canUpdateUser = (currentUserRole: MembershipRole, targetUser: MembershipRole) => currentUserRole > targetUser;
 ...
 */
export const canChangeBilling = (currentUserRole: MembershipRole) => currentUserRole === MembershipRole.Owner;
 ...
 * By default, only Owners and Admin can invite users
 */
export const canInviteUsers = (currentUserRole: MembershipRole) => currentUserRole >= MembershipRole.Admin;
 ...
 * @name canInviteUser
 */
export const canInviteUser = (inviterRole: MembershipRole, inviteeRole: MembershipRole) => {
 ...
 */
export const canDeleteInvites = (inviterRole: MembershipRole) => canInviteUsers(inviterRole);
