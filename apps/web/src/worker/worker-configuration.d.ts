/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker/worker-configuration.d.ts` (hash: e33613cf7e44458be8a663dcfa73d65a)
// Runtime types generated with workerd@1.20260722.1 2026-07-22 nodejs_compat
interface __BaseEnv_Env {
	VAULT_FILES: R2Bucket;
	DB: D1Database;
	EMAIL: SendEmail;
	PUBLIC_HOST: "inteligir.com";
	BETTER_AUTH_SECRET: string;
	UserHost: DurableObjectNamespace<import("./server").UserHost>;
	AGENT_SANDBOX: DurableObjectNamespace<import("./server").AgentSandbox>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./server");
		durableNamespaces: "UserHost" | "AgentSandbox";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_HOST" | "BETTER_AUTH_SECRET">> {}
}
