/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker/worker-configuration.d.ts` (hash: fd92a841ad1438142fc3397dc593e1be)
// Runtime types generated with workerd@1.20260921.1 2026-08-15 nodejs_compat
interface __BaseEnv_Env {
	PACK_CACHE: R2Bucket;
	DB: D1Database;
	EMAIL: SendEmail;
	VAULT_STORAGE_CAP_BYTES: "1073741824";
	THREAD_SYNC: DurableObjectNamespace<import("./server").ThreadSyncDO>;
	REPO: DurableObjectNamespace<import("./server").RepoCell>;
	REGISTRY: DurableObjectNamespace<import("./server").Registry>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./server");
		durableNamespaces: "ThreadSyncDO" | "RepoCell" | "Registry";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VAULT_STORAGE_CAP_BYTES">> {}
}
