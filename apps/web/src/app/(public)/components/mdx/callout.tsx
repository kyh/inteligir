...
export const Callout: React.FC<{
  ...
  return (
    <div
      className={clx(`flex space-x-2 rounded-md border pr-4`, className, {
    ...
    >
      ...
      >
        {variant === "warning" && (
          <ExclamationCircle className="h-5 w-5 text-yellow-600" />
        )}
        {variant === "danger" && (
        ...
        {variant === "info" && (
          <QuestionMarkCircle className="h-5 w-5 text-blue-600" />
        )}
      </div>
      <div
        className={clx("prose py-3", {
