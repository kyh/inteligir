...
export const GallerySection = ({ id, title, children }: GallerySectionProps) => (
...
export const Demo = ({ name, purpose, note, children, stack = false }: DemoProps) => (
...
export const DemoCase = ({ label, children }: { label: string; children: ReactNode }) => (
