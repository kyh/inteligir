  ...
  return (
    <Popover modal={false} onOpenChange={setOpen} open={open}>
      <PopoverTrigger asChild>
        <Button className="font-medium text-muted-foreground" size="xs" variant="outline">
          {children}
        </Button>
      </PopoverTrigger>
      ...
      >
        <Tabs defaultValue="gallery">
          ...
          <TabsContent className="my-3 space-y-3 px-2 text-center" value="upload">
            ...
            <div className="text-muted-foreground text-xs">The maximum size per file is 5MB</div>
          </TabsContent>
